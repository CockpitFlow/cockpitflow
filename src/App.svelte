        ...
        <div class="settings-page">
          ...
          <div class="cl-card">
            ...
            <div class="cl-meta">
              ...
              <span class="cl-meta-detail" style="margin-top:4px"><a href="https://github.com/CockpitFlow/cockpitflow" target="_blank" style="color:var(--color-accent);text-decoration:none">GitHub</a> &middot; <a href="https://cockpitflow.github.io/cockpitflow-site/" target="_blank" style="color:var(--color-accent);text-decoration:none">Website</a></span>
            </div>
          </div>
        </div>
      {/if}
...
<style>
  ...
  .settings-page .cl-card { min-width: 250px; }
